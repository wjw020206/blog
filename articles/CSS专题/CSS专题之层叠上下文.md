...
知道了前面这些，可能还是不太清楚遇到元素层叠的时候如何判断谁在上，谁在下。
...
- **在同一个层叠上下文中：**
  - 参考前面的 “层叠顺序图”，**谁的层级高谁就盖住谁**
- **不在同一个层叠上下文中（分别属于不同上下文）：**
  - 先比较它们各自 “所属层叠上下文” 的层级，谁的 “所属层叠上下文” 的层级高，谁就整体在上

**第二步：如果层叠上下文层级相同，再比较 DOM 结构顺序** 

- 当两个元素分别属于 **不同层叠上下文**，而它们的“父层叠上下文”的层级**刚好相同**时，
